...
export function renderHTML(body, pLink, pIdx) {
  ...
  <html lang="en">
    <head>
      ...
      <link href="https://cdn.jsdelivr.net/gh/wesleywxie/onedrive-cf-index@${COMMIT_HASH}/themes/spencer.css" rel="stylesheet">
      <link href="https://cdn.jsdelivr.net/gh/sindresorhus/github-markdown-css@gh-pages/github-markdown.css" rel="stylesheet">
      <link href="https://cdn.jsdelivr.net/gh/wesleywxie/onedrive-cf-index@${COMMIT_HASH}/themes/prism-github.css" rel="stylesheet">
    ...
    <body>
      <nav id="navbar" data-turbolinks-permanent><div class="brand">📁 我的网盘 </div></nav>
      ${body}
      <div class="paginate-container">${pagination(pIdx)}</div>
      <div id="flex-container" data-turbolinks-permanent style="flex-grow: 1;"></div>
      <footer id="footer" data-turbolinks-permanent><p>Hosted on <a href="https://www.cloudflare.com/products/cloudflare-workers/">Cloudflare Workers</a>.</p></footer>
      <script>
